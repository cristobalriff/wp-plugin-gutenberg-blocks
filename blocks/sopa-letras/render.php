...
<div <?php echo $anchor; ?>class="<?php echo esc_attr($class_name); ?> acfb-bg-yellow-300 acfb-p-8 acfb-font-sans"
    ...
    <main class="acfb-flex acfb-flex-col md:acfb-flex-row acfb-gap-8">
        ...
        <section class="acfb-flex-grow acfb-flex acfb-justify-center acfb-items-start acfb-overflow-auto">
            <div
                class="acfb-bg-white acfb-border-6 acfb-border-black acfb-p-6 acfb-shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] acfb-select-none">
                <div class="grid-container acfb-grid acfb-gap-3 acfb-bg-black acfb-p-4">
    ...
    <div
        ...
        <div
            class="acfb-bg-lime-300 acfb-border-6 acfb-border-black acfb-shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] acfb-p-10 acfb-max-w-md acfb-w-full acfb-text-center">
            <div
